...
const INITIAL_STAGES: PipelineStage[] = [
  ...
  { id: 'literature',  label: 'Literature Evidence Retrieval', status: 'idle', detail: 'PubMed · top 5 papers' },
  { id: 'confidence',  label: 'Experiment Confidence Evaluation', status: 'idle' },
